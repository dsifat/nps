        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    {!! Form::open(['route' => 'backend.teams.store', 'files'=>'true']) !!}
                            ...
                            <div class="download-section col-md-6">
                                ...
                                <div class="sample-file-text">
                                    ...
                                    Before uploading the file please
                                      <a href="{{ url('/download/sample_team_members_list.xlsx') }}">
                            ...
                            <div class="form-input-section col-md-4">
                                ...
                                <div class="file-upload-section">
                                    <div class="d-flex flex-column form-group">
                                        <label for="team_members_list">File Upload</label>
                                        <input type="file" name="team_members_list" placeholder="Choose File">
                                    </div>
                                </div>
                            </div>
                        </div>
