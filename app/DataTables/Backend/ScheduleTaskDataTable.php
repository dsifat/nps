...
class ScheduleTaskDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'backend.schedule_tasks.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\ScheduleTask $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ScheduleTask $model)
    {
    ...
    {
        return 'schedule_tasks_datatable_' . time();
    }
}
