...
class PhoneGroupDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'backend.phone_groups.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\PhoneGroup $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(PhoneGroup $model)
    {
    ...
    {
        return 'phone_groups_datatable_' . time();
    }
}
