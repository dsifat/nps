...
class EmailGroupDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'backend.email_groups.datatables_actions');
    }
     ...
     */
    public function query(EmailGroup $model)
    {
